...
FROM ghcr.io/containerbase/sidecar:14.5.2@sha256:1e95b5433decc7dcd9d4122fdec97936c513faf0a1656455eb3560e9275f7fa9 AS base
...
RUN install-tool gradle 9.4.0


# renovate: datasource=github-releases packageName=containerbase/erlang-prebuild versioning=docker
RUN install-tool erlang 28.4.0.0
...
# renovate: datasource=pypi
RUN install-tool copier 9.13.0
...
# renovate: datasource=pypi
RUN install-tool uv 0.10.9


# renovate: datasource=docker
RUN install-tool rust 1.94.0
